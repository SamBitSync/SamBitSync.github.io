...
A bad explanation is easy to vary: change the details arbitrarily and it still "explains" the phenomenon. A good explanation is constrained: all its details play a functional role, so changing any part breaks the explanation.
