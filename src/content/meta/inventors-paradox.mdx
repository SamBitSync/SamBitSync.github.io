...
Complements the Fundamental Paradox of Social Science: that one says "go general to solve specifics", the other says "go specific to make general claims". They target different phases. Inventor's Paradox is for problem-solving; Social Science Paradox is for inference.
